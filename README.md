...
> **Personal fork** — I'm using this for learning and experimenting with LLM-driven trading strategies. My notes and tweaks are tracked in [PERSONAL_NOTES.md](PERSONAL_NOTES.md).
